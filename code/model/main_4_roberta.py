...
path = f"/home/user/lh/PMA_lihang/data/data118_root_cause_train_v2.csv"  #    
# path = "/home/user/lh/PMA_lihang/data/myData118_root_cause_train_1e-4_v2_plus.csv"
dataset = MyDataset(path, tokenizer)
dataloader = DataLoader(dataset, batch_size=64, shuffle=True, drop_last=True)

path_eval = f"/home/user/lh/PMA_lihang/data/data118_root_cause_eval_v2.csv"  #    
# path_eval = "/home/user/lh/PMA_lihang/data/myData118_root_cause_eval_1e-4_v2_plus.csv"
...
# path_test = f"/home/user/lh/PMA_lihang/data/data118_root_cause_test_v2.csv"  #    
path_test = "/home/user/lh/PMA_lihang/data/myData118_root_cause_test_1e-4_v2_plus.csv"
...
#         flag = 0
#         f1_eval = f1_eval_now
#         # torch.save(model.state_dict(), f"/home/user/lh/PMA_lihang/code_lihang/model/myModel118_4_roberta.pth")
#         torch.save(model.state_dict(), f"/home/user/lh/PMA_lihang/code_lihang/model/model118_4_roberta.pth")
...
model = RobertaForSequenceClassification.from_pretrained("roberta-base", num_labels=13)
model.load_state_dict(torch.load(f"/home/user/lh/PMA_lihang/code_lihang/model/model118_4_roberta.pth"))
model.to(device)
model.eval()
