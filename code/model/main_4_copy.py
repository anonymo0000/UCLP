...
# path = "/home/user/Programs/PMA_lihang/data/data118_root_cause_train_v2.csv"
...
#         path = "/home/user/Programs/PMA_lihang/data/data118_root_cause_eval_v2.csv"
...
#             f1_eval = f1_eval_now
#             acc = correct/total
#             torch.save(model.state_dict(),f"/home/user/Programs/PMA_lihang/code_lihang/model/model118_4_2norlstm.pth")
...
model.load_state_dict(torch.load(f"/home/user/Programs/PMA_lihang/code_lihang/model/model118_4_2norlstm.pth"))
#     GPU 
model.to(device)

model.eval()
#      
# path = "/home/user/Programs/PMA_lihang/data/data118_root_cause_test_v2.csv"

path = "/home/user/Programs/PMA_lihang/data/myData118_root_cause_test_1e-4_v2_plus.csv"
