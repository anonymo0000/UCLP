...
# # # path = f"/home/user/Programs/PMA_lihang/data/myData118_v_type_train{mod}.csv" #   
...
#     #    ，     
#     model.eval()
#     path = "/home/user/Programs/PMA_lihang/data/data118_v_type_eval.csv"
...
#             f1_eval = f1_eval_now
#             acc = correct/total
#             torch.save(model.state_dict(),f"/home/user/Programs/PMA_lihang/code_lihang/model/model118_1_1k_2norlstm.pth")
...
model = Text2norLstm()
model.load_state_dict(torch.load("/home/user/Programs/PMA_lihang/code_lihang/model/model118_1_1k_2norlstm.pth"))
# model.load_state_dict(torch.load(f"/home/user/Programs/PMA_lihang/code_lihang/model/myModel118_1_1k{mod}.pth"))
#     GPU 
model.to(device)
