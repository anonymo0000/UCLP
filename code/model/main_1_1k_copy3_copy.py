...
from PMA import Text2norLstm  # Text2norLstm #Text2norLstm #Text2norLstm #
import torch
    ...
    if epoch % 50 == 0:
        ...
        if f1_eval_now > f1_eval + 0.005:
            ...
            torch.save(model.state_dict(),
                       f"/home/user/Programs/PMA_lihang/code_lihang/model/myModel118_1_1k{mod}_2norlstm.pth")
...
model.load_state_dict(torch.load(f"/home/user/Programs/PMA_lihang/code_lihang/model/myModel118_1_1k{mod}_2norlstm.pth"))
#      GPU 
model.to(device)
