...
#         torch.save(model.state_dict(), f"/home/user/lh/PMA_lihang/code_lihang/model/model118_1_bert_temp.pth")
...
# exit(0)
model = Text2Transformer("bert-base-uncased")  #         
model.load_state_dict(torch.load(f"/home/user/lh/PMA_lihang/code_lihang/model/model118_1_bert.pth"))
model.to(device)
model.eval()
...
with torch.no_grad():
    for i, data in enumerate(dataloader_test):
        ...
        outputs, attention_weights = model(inputs, attention_mask=attention_mask)
