...
#    
path = "/home/user/Programs/PMA_lihang/data/data_att_type_train.csv"
...
for epoch in range(20):
    ...
    #   batch loss    
    print("    ")
    path = "/home/user/Programs/PMA_lihang/code_lihang/loss.txt"
...
model.eval()
#      
path = "/home/user/Programs/PMA_lihang/data/data_att_type_test.csv"
dataset = MyDataset(path)
dataloader = DataLoader(dataset,batch_size=64,shuffle=True)
#  ，     
correct = 0
