...
#             f1_eval = f1_eval_now
#             acc = correct/total
#             torch.save(model.state_dict(),f"/home/user/Programs/PMA_lihang/code_lihang/model/myModel118_{model_index}{mod}_1lstm.pth")
...
model.load_state_dict(torch.load(f"/home/user/Programs/PMA_lihang/code_lihang/model/myModel118_{model_index}{mod}_1lstm.pth"))
#     GPU 
model.to(device)
