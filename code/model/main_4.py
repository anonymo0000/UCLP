...
#    
path = "/home/user/Programs/PMA_lihang/data/data_root_cause_train.csv"
...
for epoch in range(20):
    ...
    #    ，     
    model.eval()
    path = "/home/user/Programs/PMA_lihang/data/data_root_cause_eval.csv"
    dataset = MyDataset(path)
    dataloader = DataLoader(dataset,batch_size=64,shuffle=True)
    correct = 0
    total = 0
    ...
    if correct/total > acc:
        acc = correct/total
        torch.save(model.state_dict(),"/home/user/Programs/PMA_lihang/code_lihang/model/model_4.pth")
