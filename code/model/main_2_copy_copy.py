...
#             f1_eval = f1_eval_now
#             acc = correct/total
#             torch.save(model.state_dict(),f"/home/user/Programs/PMA_lihang/code_lihang/model/model118_2_1bilstm.pth")
...
model.load_state_dict(torch.load(f"/home/user/Programs/PMA_lihang/code_lihang/model/model118_2_1bilstm.pth"))
#     GPU 
model.to(device)
...
path = "/home/user/Programs/PMA_lihang/data/myData118_att_type_test_1e-4_v2.csv"
