...
path = f"/home/user/Programs/PMA_lihang/data/data118_att_type_train.csv"  #    
# path = "/home/user/Programs/PMA_lihang/data/myData118_att_type_train_1e-4_v2.csv"
dataset = MyDataset(path, tokenizer)
dataloader = DataLoader(dataset, batch_size=64, shuffle=True, drop_last=True)

path_eval = f"/home/user/Programs/PMA_lihang/data/data118_att_type_eval.csv"  #    
# path_eval = "/home/user/Programs/PMA_lihang/data/myData118_att_type_eval_1e-4_v2.csv"
...
path_test = f"/home/user/Programs/PMA_lihang/data/myData118_att_type_test_1e-4_v2.csv"  #    
# path_test = "/home/user/Programs/PMA_lihang/data/data118_att_type_test.csv"
...
#         flag = 0
#         f1_eval = f1_eval_now
#         # torch.save(model.state_dict(), f"/home/user/Programs/PMA_lihang/code_lihang/model/myModel118_2_bert.pth")
#         torch.save(model.state_dict(), f"/home/user/Programs/PMA_lihang/code_lihang/model/model118_2_bert.pth")
...
# exit(0)
model = Text2Transformer("bert-base-uncased")  #         
model.load_state_dict(torch.load(f"/home/user/Programs/PMA_lihang/code_lihang/model/model118_2_bert.pth"))
model.to(device)
model.eval()
