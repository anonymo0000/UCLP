...
for epoch in range(2101):
    ...
    if epoch % 50 == 0:
        ...
        if f1_eval_now > f1_eval + 0.005:
            ...
            f1_eval = f1_eval_now
            acc = correct/total
            torch.save(model.state_dict(),f"/home/user/Programs/PMA_lihang/code_lihang/model/myModel118_{model_index}{mod}_1cnn.pth")
...
model.load_state_dict(torch.load(f"/home/user/Programs/PMA_lihang/code_lihang/model/myModel118_{model_index}{mod}_1cnn.pth"))
#     GPU 
model.to(device)
...
path = "/home/user/Programs/PMA_lihang/data/myData118_att_type_test_0.csv"
