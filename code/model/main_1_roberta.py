...
#         flag = 0
#         f1_eval = f1_eval_now
#         torch.save(model.state_dict(), f"/home/user/lh/PMA_lihang/code_lihang/model/myModel118_1_roberta.pth")
...
model = RobertaForSequenceClassification.from_pretrained("roberta-base", num_labels = 13)
model.load_state_dict(torch.load(f"/home/user/lh/PMA_lihang/code_lihang/model/myModel118_1_roberta.pth"))
model.to(device)
model.eval()
