...
# path = "/home/user/Programs/PMA_lihang/data/data118_att_vec_train.csv"
...
#         path = "/home/user/Programs/PMA_lihang/data/data118_att_vec_eval.csv"
...
#             f1_eval = f1_eval_now
#             acc = correct/total
#             torch.save(model.state_dict(),f"/home/user/Programs/PMA_lihang/code_lihang/model/model118_3_bilstm.pth")
...
model.load_state_dict(torch.load(f"/home/user/Programs/PMA_lihang/code_lihang/model/model118_3_bilstm.pth"))
#     GPU 
model.to(device)

model.eval()
#      
# path = "/home/user/Programs/PMA_lihang/data/data118_att_vec_test.csv"

path = "/home/user/Programs/PMA_lihang/data/myData118_vec_test_1e-4_v2.csv"
