...
for epoch in range(2100):
    ...
    if epoch % 50 == 0:
        ...
        if f1_eval_now > f1_eval:
            ...
            f1_eval = f1_eval_now
            acc = correct/total
            torch.save(model.state_dict(),f"/home/user/Programs/PMA_lihang/code_lihang/model/myModel118_1_1k{mod}_v2.pth")
...
model.load_state_dict(torch.load(f"/home/user/Programs/PMA_lihang/code_lihang/model/myModel118_1_1k{mod}_v2.pth"))
#     GPU 
model.to(device)
