...
from PMA import PMA_4_drop1_5#PMA_4
import torch
...
for epoch in range(2101):
    ...
    if epoch % 50 == 0:
        ...
        if f1_eval_now > f1_eval+0.005:
            ...
            f1_eval = f1_eval_now
            acc = correct/total
            torch.save(model.state_dict(),f"/home/user/Programs/PMA_lihang/code_lihang/model/myModel118_{model_index}{mod}_1cnn_plus.pth")
...
model.load_state_dict(torch.load(f"/home/user/Programs/PMA_lihang/code_lihang/model/myModel118_{model_index}{mod}_1cnn_plus.pth"))
#     GPU 
model.to(device)
...
path = f"/home/user/Programs/PMA_lihang/data/myData118_{name}_test{mod}_v2_plus.csv"
