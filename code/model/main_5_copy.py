...
path = "/home/user/Programs/PMA_lihang/data/data118_root_cause_train.csv"


# path = f"/home/user/Programs/PMA_lihang/data/myData118_att_type_train{mod}.csv" #   
...
for epoch in range(2105):
    ...
    if epoch % 50 == 0:
        ...
        path = "/home/user/Programs/PMA_lihang/data/data118_root_cause_eval.csv"
        # path = f"/home/user/Programs/PMA_lihang/data/myData118_v_type_eval{mod}.csv"
        dataset = MyDataset(path)
        dataloader = DataLoader(dataset,batch_size=64,shuffle=True,drop_last=True)
        correct = 0
        total = 0
        ...
        if f1_eval_now > f1_eval:
            f1_eval = f1_eval_now
            acc = correct/total
            torch.save(model.state_dict(),f"/home/user/Programs/PMA_lihang/code_lihang/model/model118_4.pth")
...
model.load_state_dict(torch.load(f"/home/user/Programs/PMA_lihang/code_lihang/model/model118_4.pth"))
#     GPU 
model.to(device)

model.eval()
#      
path = "/home/user/Programs/PMA_lihang/data/data118_root_cause_test.csv"

# path = f"/home/user/Programs/PMA_lihang/data/data118_att_type_test.csv"
# path = "/home/user/Programs/PMA_lihang/data/myData118_att_type_test_1e-4.csv"
