...
path = f"/home/user/lh/PMA_lihang/data/myData118_impact_train_1e-4_v2.csv"  #    
# path = "/home/user/lh/PMA_lihang/data/myData118_vec_train_1e-4_v2.csv"
dataset = MyDataset(path, tokenizer)
dataloader = DataLoader(dataset, batch_size=64, shuffle=True, drop_last=True)

path_eval = f"/home/user/lh/PMA_lihang/data/myData118_impact_eval_1e-4_v2.csv"  #    
...
path_test = "/home/user/lh/PMA_lihang/data/myData118_impact_test_1e-4_v2.csv"
...
#         optimizer.zero_grad()
#         outputs,att = model(inputs, attention_mask=attention_mask)
...
#         flag = 0
#         f1_eval = f1_eval_now
#         torch.save(model.state_dict(), f"/home/user/lh/PMA_lihang/code_lihang/model/myModel118_5_bert_now.pth")
...
# exit(0)
model = Text2Transformer("bert-base-uncased")  #         
model.load_state_dict(torch.load(f"/home/user/lh/PMA_lihang/code_lihang/model/myModel118_5_bert_now.pth"))
model.to(device)
model.eval()
