...
# path = f"/home/user/Programs/PMA_lihang/data/myData118_{name}_train{mod}_v2_noOther.csv" #   
...
#         path = f"/home/user/Programs/PMA_lihang/data/myData118_{name}_eval{mod}_v2_noOther.csv"
#         dataset = MyDataset(path)
#         dataloader = DataLoader(dataset,batch_size=64,shuffle=True,drop_last=True)
#         correct = 0
#         total = 0
...
#             f1_eval = f1_eval_now
#             acc = correct/total
#             torch.save(model.state_dict(),f"/home/user/Programs/PMA_lihang/code_lihang/model/myModel118_{model_index}{mod}_2norlstm_noOther.pth")
...
model.load_state_dict(torch.load(f"/home/user/Programs/PMA_lihang/code_lihang/model/myModel118_{model_index}{mod}_2norlstm.pth"))
#     GPU 
model.to(device)
...
# path = f"/home/user/Programs/PMA_lihang/data/myData118_{name}_test{mod}_v2_noOther.csv"
