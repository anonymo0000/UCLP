...
for epoch in range(10):
    ...
    if f1_eval_now > f1_eval + 0.005:
        flag = 0
        f1_eval = f1_eval_now
        # torch.save(model.state_dict(), f"/home/user/lh/PMA_lihang/code_lihang/model/myModel118_4_bert.pth")
        torch.save(model.state_dict(), f"/home/user/lh/PMA_lihang/code_lihang/model/model118_4_bert.pth")
...
# exit(0)
model = Text2Transformer("bert-base-uncased")  #         
model.load_state_dict(torch.load(f"/home/user/lh/PMA_lihang/code_lihang/model/model118_4_bert.pth"))
model.to(device)
model.eval()
